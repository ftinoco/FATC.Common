...
namespace FATC.Common.Extensions
{
    ...
    {
        public static KeyValuePair<string, string> GetPropertyByName(this object model, string property)
        {
        ...
        public static Dictionary<string, object> GetAllPropertiesModelUpperCase(this object model, List<string> excludedColumns)
        {
        ...
        public static Dictionary<string, object> GetAllPropertiesModel(this object model, List<string> excludedColumns)
        {
            Dictionary<string, object> procedures = new Dictionary<string, object>();
            if (model != null)
            {
